...
import 'edit_flow_test.dart' as edit_flow;
...
import 'metadata_flow_test.dart' as metadata_flow;
...
void main() {
  ...
  group('metadata_flow', metadata_flow.main);
  ...
  group('edit_flow', edit_flow.main);
